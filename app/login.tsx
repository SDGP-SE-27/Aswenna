...
//             console.log("Received Role:", data.role);  // ✅ Ensure role is received
//             console.log("Received Username:", data.username);
//             console.log("Received Token:", data.access); // ✅ Log access token

//             // ✅ Explicitly store the token
//             await AsyncStorage.setItem("accessToken", data.access);
//             await AsyncStorage.setItem("username", data.username);
//             await AsyncStorage.setItem("role", data.role);  // ✅ Store role for later use
...
//             console.log("Role stored in AsyncStorage:", data.role);
...
//               { text: "Login", onPress: () => navigateBasedOnRole(data.role) }
//             ]);

//             // Alert.alert("Login Successful", `Welcome, ${username}!`, [
//             //   { text: "Login", onPress: () => navigation.navigate("Homepage") }  // Navigate after clicking OK
//             // ]);
